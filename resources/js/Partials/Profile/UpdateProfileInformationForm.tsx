                ...
                <div className="grid md:grid-cols-2 gap-x-6">
                    <div className="mb-2">
                        ...
                        <InputIcon
                            ...
                            onChange={e =>
                                form.setData('job_title', e.currentTarget.value)
                            }
                        />
                    </div>
                    <div className="mb-2">
                        ...
                        <InputIcon
                            ...
                            onChange={e =>
                                form.setData('at_job', e.currentTarget.value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-x-6">
                    ...
                    <div className="mb-2">
                        ...
                        <InputIcon
                            ...
                            onChange={e =>
                                form.setData('github', e.currentTarget.value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-1 gap-x-6">
                    <div className="mb-2">
                        ...
                        <InputIcon
                            ...
                            onChange={e =>
                                form.setData('twitter', e.currentTarget.value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-x-6">
                    <div className="mb-2">
                        ...
                        <InputIcon
                            ...
                            onChange={e =>
                                form.setData('instagram', e.currentTarget.value)
                            }
                        />
                    </div>
                    <div className="mb-2">
                        ...
                        <InputIcon
                            ...
                            onChange={e =>
                                form.setData('facebook', e.currentTarget.value)
                            }
                        />
                    </div>
                </div>
            ...
            <div className="col-span-7">
                <div className="flex items-center mb-2 gap-x-3">
                    ...
                    <Checkbox
                        ...
                        onChange={e =>
                            form.setData('is_private', e.currentTarget.checked)
                        }
                    />
